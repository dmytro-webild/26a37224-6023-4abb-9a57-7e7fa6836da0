...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "In a digital landscape crowded with noise, we cut through with precision.",        "Our team of strategists, copywriters, and designers create compelling visual identities that don't just get seen—they get felt.",        "We treat every brand as a unique entity, crafting bespoke social ecosystems that drive measurable, long-term growth."]}
    />
  </div>
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        {
          id: "m1",          value: "200M+",          title: "Reach Delivered",          description: "Monthly audience impact",          icon: Zap,
        },
        {
          id: "m2",          value: "4.8x",          title: "Average ROAS",          description: "Campaign efficiency gain",          icon: TrendingUp,
        },
        {
          id: "m3",          value: "150+",          title: "Brands Scaled",          description: "Across five continents",          icon: Globe,
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "3",          name: "Sarah L.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BZmOgDqZ2woM6lP5WKEEhKjIcu/close-up-headshot-of-a-tech-startup-foun-1774704971193-b4009214.png"},
        {
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[{ text: "Inquire Now", href: "mailto:hello@elitesocial.agency" }]}
    />
  </div>
